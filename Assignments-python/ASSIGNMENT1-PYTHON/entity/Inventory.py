from Exception import InvalidDataException,InsufficientStockException
    ...
    def Get_Product(self,InventoryID):
        try:
            ...
            if product_data:
                ...
                print(f"Product ID: {product_id}, Product Name: {product_name}, Description: {description}, Price: rs{price}")
            else:
