...
class Course:
    ...
    """
python_teacher = Teacher(1,"Karthika", "Thangiraj","karthikamca@gmail.com")

python_course = Course(101, "Python",202,"karthika")
...
python_course.UpdateCourseInfo(101,"Python+Pyunit", "102","Prof.Karthika")
        """
...
python_course.DisplayCourseInfo()
    ...
    """
student_1 = Student(StudentID=1, FirstName="Aniket", LastName="Biyani", DateOfBirth=datetime(2002, 8, 3), Email="aniket@email.com", PhoneNumber="1234567890")
student_2 = Student(StudentID=2, FirstName="Abhi", LastName="Surya", DateOfBirth=datetime(2001, 2, 2), Email="abhi@email.com", PhoneNumber="9876543210")
